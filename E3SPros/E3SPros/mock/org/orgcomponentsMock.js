...
// 仓库查询  'carHouseCode', 'carHouseName'
...
const supplyStatusData = Mock.mock({
  'result': '01',
  'data': {
    'mdsSupplyStatusQueryByPage': {
      'rows': [{
        supplyStatusCode: 'TR',
        supplyStatusName: '不生产不供应'
      },
      {
        supplyStatusCode: 'TP',
        supplyStatusName: '不生产供应'
      },
      {
        supplyStatusCode: 'PR',
        supplyStatusName: '生产不供应'
      },
      {
        supplyStatusCode: 'SP',
        supplyStatusName: '生产供应'
      }
      ]
    }
  },
...
const moduleNameData = Mock.mock({
  'result': '1',
  'data': {
    'mdsModuleNameQueryByPage': {
      'rows': [{
        moduleCode: 'DB',
        moduleName: '公共'
      },
...
// 全局角色查询
const sysRoleGlobalMutationSave = Mock.mock({
  result: '1',
  msg: '保存成功！'
})
...
// 客户信息查询
const oneIdCustListQueryFindAll = Mock.mock({
  result: '1',
  msg: '查询成功',
  data: {
    oneIdCustListQueryFindAll: {
      result: '1',
      msg: '查询成功',
      'rows|10': [{
        oemCode: '6345',
        ...
        carBrandCode: '6345',
        carSeriesCode: '6345',
        carServiceTypeCode: '6345',
        custClassCode: '6345',
        saName: '程路',
        freshLevel: '6345',
        classLevel: '6345',
        deliveryStart: '2019-12-03',
        deliveryEnd: '2020-12-03',
        repairStart: '2019-11-03',
        repairEnd: '2020-03-03',
        parentProperty: '6345',
        childProperty: '6345',
        distributeDateStart: '2019-11-03',
        distributeDateEnd: '2020-03-03',
        isMember: '是',
        carVSeriesCode: '6345',
        carTypeCode: '6345',
        addrCounty: '6345',
        invoiceStart: '2019-11-03',
        invoiceEnd: '2020-03-03',
        deliveryMonth: '3',
        insureComp: '保险公司',
        remark: '',
        custNo: '34343',
        ...
        custName: '李林',
        custClassName: '政府公务车',
        lastRepairManTel: '朱莉理',
        isNrepair: '是',
        distributeDate: '2019-11-03',
        cCreatedDate: '2019-11-03',
        isVip: '6345'
      }
      ]
    }
...
{
  url: orgApis.oneIdCustListQueryFindAll.APIUrl + cH + 'v=' + orgApis.oneIdCustListQueryFindAll.ServiceCode,
  type: 'post',
  response: config => {
    return oneIdCustListQueryFindAll
  } // 客户信息查询
},
// 仓库查询
{
  url: veApis.veDbCarStockHouseQueryFindAll.APIUrl + cH + 'v=' + veApis.veDbCarStockHouseQueryFindAll.ServiceCode,
  type: 'post',
  response: config => {
...
},
{
  ...
  response: config => {
    ...
    return mdsLookupValueQueryByPage
  } // 值列表查询
},
{
...
// {
//   url: orgApis.sysRoleGlobalMutationSave.APIUrl + cH + 'v=' + orgApis.sysRoleGlobalMutationSave.ServiceCode,
//   type: 'post',
//   response: config => {
//     return sysRoleGlobalMutationSave
//   }
// },
{
...
// 供应状态
{
  ...
  type: 'get',
  response: config => {
    return supplyStatusData
  }
},
// 模块名称
{
  url: '/getModuleName/list',
  type: 'get',
  response: config => {
