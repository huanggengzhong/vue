...
export default {
  name: "ConvenientContactPlace",
  props:{
	ConvenientContactPlace:{
	  value:String
	}
  },
  data() {
	return {
	  value: this.ConvenientContactPlace.value,
	...
	getData: function() {
	  ...
	  let queryObj = {
		...
		variables: {
		  ...
		  dataInfo: {lookupTypeCode:"DB0016"}//值列表编码
		}
	  };
	  ...
	  that.value=that.ConvenientContactPlace.value
	},
	reset:function(){
	  let that=this
	  this.value=""
