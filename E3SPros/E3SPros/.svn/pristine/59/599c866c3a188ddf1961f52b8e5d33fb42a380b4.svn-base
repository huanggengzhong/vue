 ...
 * @Last Modified time: 2019-10-19 11:38:40
 */

<template>
  <section>
    <el-form-item label="可兑换商品">
      <el-input readonly="readonly" v-model="input" placeholder="点击选择可兑换商品" suffix-icon="el-icon-search" @click.native="showdialog()"></el-input>
    </el-form-item>
    <!-- 弹窗 -->
