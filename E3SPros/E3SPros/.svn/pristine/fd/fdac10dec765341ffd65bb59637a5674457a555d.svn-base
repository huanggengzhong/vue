<template>
  <el-form-item label="沟通记录共享是否启用" prop="isActiveRecordShare.value">
...
export default {
  ...
  data() {
    return {
      value: this.CommunicationRecordShare.value,
  ...
  methods: {
    getData: function() {
      ...
      that.value=this.CommunicationRecordShare.value
    },
    reset: function() {
      let that = this;
      this.value = "";
