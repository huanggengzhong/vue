...
export default {
  name: "WhetherHaveDriverLicense",
  props: {
    WhetherHaveDriverLicense: {
      value: String
    }
  },
  data() {
    return {
      ...
      value: this.WhetherHaveDriverLicense.value
    };
  },
  mounted: function() {
    //this.getData();
    ...
    getData: function() {
      ...
      let queryObj = {
        ...
        variables: {
          ...
          dataInfo: { lookupTypeCode: "DB0064" } //值列表编码
        }
      };
      ...
      that.value=that.WhetherHaveDriverLicense.value
    },
    reset: function() {
      let that = this;
      this.value = "";
