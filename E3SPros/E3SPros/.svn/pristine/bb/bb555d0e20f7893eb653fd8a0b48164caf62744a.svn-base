<template>
  <section>
    <el-form-item label="发券部门">
      <el-input readonly="readonly" v-model="input" placeholder="点击选择发券部门" suffix-icon="el-icon-search" @click.native="showdialog()"></el-input>
    </el-form-item>
    <!-- 弹窗 -->
    <el-dialog title="责任部门" :visible.sync="dialogVisible" @sentData="sendCode" append-to-body width="900px" center>
      ...
      <div class="filter-container filter-params">
        <el-form>
          <el-row>
            <el-col :span="8">
              <OrganizationName :OrganizationName="OrganizationNameMain" ref="OrganizationNameMainRef" />
            </el-col>
          </el-row>
        </el-form>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      tabledatas: {
        colnames: [
          { label: "上级部门", value: "dlrCode" },
          { label: "部门名称", value: "dlrShortName" },
          { label: "科室", value: "xx" }
        ],
        tableData: [],
        queryObj: {
