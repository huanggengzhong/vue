<template>
  <div>
    ...
    <!-- 弹窗 -->
    <el-dialog title="失控原因" :visible.sync="dialogVisible" :append-to-body="true" @sentData="sendCode" width="900px" center>
      ...
      <div class="filter-container filter-params">
        <el-form>
          <el-row>
            <el-col :span="8">
                 <FailureLostControllerReasonNumber :FailureLostControllerReasonNumber="agentData" ref="FailureLostControllerReasonNumber"></FailureLostControllerReasonNumber>
            </el-col>
            <el-col :span="8">
                 <FailureLostControllerReasonName :FailureLostControllerReasonName="agentData" ref="FailureLostControllerReasonName"></FailureLostControllerReasonName>
            </el-col>
          </el-row>
        </el-form>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      input: this.swd_ReasonForLostControl.input,
      dialogVisible: false,
      agentData:{
        input:''
      },
  ...
  methods: {
    ...
    getData: function() {
      let that = this;
      that.input = this.swd_ReasonForLostControl.input;
      this.query();
    },
    //行选择事件
