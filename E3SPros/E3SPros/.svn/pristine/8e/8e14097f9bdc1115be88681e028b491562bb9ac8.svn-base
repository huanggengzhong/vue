<template>
  <div class="app-container app-container-table">
    <div class="filter-container filter-button">
      ...
      <el-button type="primary" size="small" @click.native="newData()">新增</el-button>
      <el-button type="primary" size="small" @click.native="modifyData()">修改</el-button>
    ...
    <el-col :span="5" >
      ...
      <el-input v-model="sparePartNo" clearable size="small" ></el-input>
    </el-col>  
    <el-col :span="5" >
      <lableName curLabelName="互换码名称" 
                      :isShowLabel="true" 
                      :isRequire="false"></lableName>
      <el-input v-model="sparePartName" clearable size="small"></el-input>
    </el-col>
    ...
    />
     <exchangeCodeDialog ref="exchangeCodeDialog" 
                :exchangeCodeDialogVisible="exchangeCodeDialogVisible"
                :key="exchangeCodeDialogVisible"
                :editData="gridData"
...
<script>
 ...
 import exchangeCodeDialog from './exchangeCodeDialog'
  ...
  methods:{
    ...
    newData(formName){  //新增
        if(this.rowColumn.isTrusted){
          this.gridData='';
          this.exchangeCodeDialogVisible=true;
        }else{
          this.gridData='';
          this.exchangeCodeDialogVisible=true;
        }
    ...
    modifyData(){  //修改
      if(this.rowColumn.isTrusted){
        this.exchangeCodeDialogVisible=true;
        this.gridData=this.rowDetail;

        // this.$refs.exchangeCodeDialog.setEditData(this.rowDetail);
    ...
    closeeditDialogMaintenance(val){  //弹窗关闭
      this.exchangeCodeDialogVisible = val;
    },
