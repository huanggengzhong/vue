  ...
  data() {
    return {
      ...
      tableComponents: [
        ...
        // {compKey: 'compKey13', labelName: '仓库分类', codeField: 'carStoreClass',  component: () => import('@/components/org/commonInput'), type: 'inputText', hidden: true, isMust: true},
        // {
        //   compKey: "compKey15",
  ...
  methods: {
    onCreated() {
      if (this.isAdd()) {
        ...
        this.formField.carHouseCode = this.$utils.guid()
      }
      console.log(this)
    },
    getCarhouseType() {
    ...
    save() {
      ...
      this.formField.dlrShortName = undefined;
      if (this.valid) {
        //保存表单
        this.saveForm();
      }
