      ...
      tableComponents:
        ...
        CacheConfig.cacheData[this.$route.path].tableComponents.length > 0
          ...
          : [
              ...
              {
                compKey: "compKey15",
                labelName: this.$t("org.label.warnHomeType") /*仓库分类*/,
    ...
    getCols() {
      ...
      if (
        ...
        cols = cols.concat([
          ...
          { prop: "isEnable", label: this.$t("org.label.isEffective"), width: null, align: "center" },/*是否有效*/
          {
