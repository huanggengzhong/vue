<template>
  <el-form-item label="电销员">
    <el-select v-model="value" placeholder="请选择" clearable>
      <el-option v-for="item in options" :key="item.empId" :label="item.empName" :value="item.empId"></el-option>
    </el-select>
  </el-form-item>
</template>
...
export default {
  ...
  methods: {
    getData: function() {
      ...
      this.value = this.Telemarketer.value;
    },
    reset: function() {
      let that = this;
      this.value = "";
