<template>
  <el-form-item label="自动分配开关是否启用" prop="isAutoAssgin.value">
...
export default {
  name: "AutomaticDistributionSwitch",
  props:{
  ...
  data() {
    return {
      ...
      value: this.AutomaticDistributionSwitch.value
    };
  },
  mounted: function() {
    this.getData();
  ...
  methods: {
    getData: function() {
      ...
      that.value=this.AutomaticDistributionSwitch.value
