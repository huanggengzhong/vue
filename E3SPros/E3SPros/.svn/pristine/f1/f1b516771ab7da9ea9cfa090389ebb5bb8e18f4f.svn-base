<template>
  <div class="app-container app-container-table">
    ...
    <div class="filter-container filter-params">
      <el-row :gutter="26">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForms" class="demo-ruleForm">
          <el-row>
            <el-col :span="6">
            ...
            <el-col :span="6">
              <el-form-item label="操作原因" prop="ruleForm.operateReason">
...
export default {
  ...
  methods: {
    ...
    handleChangeImport(param) {
      ...
      var that = this;
      var firstUrl=this.uploadUrl();
      this.$requestImport(firstUrl, param, function(response) {
        debugger
        // that.uploadSuccess(response)
      })
      this.$requestImport(url, param, function(response) {      
