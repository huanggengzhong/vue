...
export default {
  ...
  data() {
    return {
      value: this.introducerRelationship.value,
    ...
    getData: function() {
      ...
      let queryObj = {
        ...
        variables: {
          ...
          dataInfo: {lookupTypeCode:'DB0019'}//值列表编码
        }
      };
      ...
      that.value=that.introducerRelationship.value
    },
    reset:function(){
      let that=this
      this.value=''
