...
export default {
  ...
  data() {
    return {
      value: this.ContactStatus.value,
      options:this.getData(),
      isdisabled:this.ContactStatus.isdisabled
    };
  },
  mounted: function() {
    //this.getData();
    ...
    getData: function() {
      ...
      let queryObj = {
        ...
        variables: {
          ...
          dataInfo: {lookupTypeCode:'TOUCHSTATE'}//值列表编码
        }
      };
      ...
      that.value=this.ContactStatus.value
    },
    reset:function(){
      let that=this
      this.value=''
