    ...
    return {
      ...
      tableButtons: [
        ...
        } /*查询*/,
        {
          ...
          text: this.$t("org.label.priceSetting")
        } /*价格设置*/,

        {
          ...
          text: this.$t("org.label.stockPpecialCar")
        } /*库存特价车*/,
        {
          compKey: "btnKey3",
          type: "",
      ...
      tableComponents:
        ...
        CacheConfig.cacheData[this.$route.path].tableComponents.length > 0
          ...
          : [
              ...
              {
                compKey: "compKey6",
                labelName: this.$t("org.label.isSetting") /*已设置*/,
                codeField: "isSet",
      ...
      tableCols:
        ...
        CacheConfig.cacheData[this.$route.path].tableCols.length > 0
          ...
          : [
              ...
              {
                prop: "invoiceLimitPrice",
                label: this.$t("org.label.invoicingCurrentPrice") /*开票现价*/,
                width: 90,
                align: "center"
              },
              {
              ...
              {
                prop: "storeQTY",
                label: this.$t("org.label.inventory") /*库存数*/,
                width: 90,
                align: "center"
              },
              {
  ...
  methods: {
    ...
    editTable() {
      ...
      if (selectData.length != 1) {
        this.$message({
          message: this.$t("org.message.selOneData") /*选择一条数据*/,
          type: "warning"
        });
        return false;
      }
