  ...
  <div class="app-container app-container-table">
    ...
    <div class="filter-container filter-params">
      <el-row :gutter="26">
            ...
            <LookupValue :span = "6" :isShowLabel="true" labelName="单据类型" @changeCode="getCode" lookuptype="PA0122" :code="queryParams.dataInfo.billType" />
            <el-col :span="6">
               <label>单据日期</label>
              <el-date-picker
...
export default {
  ...
  data() {
    return {
       ...
       queryParams: {
        APIUrl: paApis.paBuOemOutStoreQueryFindAllOrderCode.APIUrl,
        InputType: paApis.paBuOemOutStoreQueryFindAllOrderCode.InputType,
        ServiceCode: paApis.paBuOemOutStoreQueryFindAllOrderCode.ServiceCode,
        dataInfo: {
          billNo: '',
          billType: '3',
          dlrId:'',
  ...
  created() {
      this.queryParams.dataInfo.dlrId = this.$store.getters.orgInfo.DLR_ID
  ...
  methods:{
    ...
    changeDate(){
      this.queryParams.dataInfo.outBoundDateBegin = this.outBoundDate[0]
      this.queryParams.dataInfo.outBoundDateEnd = this.outBoundDate[1]
    },
    getCode(val){
