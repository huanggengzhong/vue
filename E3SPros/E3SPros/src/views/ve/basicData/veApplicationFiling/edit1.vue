  ...
  data() {
    return {
      ...
      staticTableComponents: [
        ...
        {compKey: 'compKey6', labelName: this.$t('org.label.motorType'), lookuptype: 'VE0079', codeField: 'motorType', component: () => import('@/components/org/LookupValue'), type: 'dropdownList', isMust: false},//电机类型
