    ...
    return {
      ...
      tableButtons: [
        ...
        name: "search", //按钮图标样式
          position: "right",
          fuzzySearch: true},//查询
        {compKey: 'btnKey2', type: '', size: 'small', clickEvent: () => this.synchrony(), text:this.$t('sys.button.sync'),
        name: "", //按钮图标样式
          position: "left",
          fuzzySearch: true},// '同步'
        {compKey: 'btnKey4', type: '', size: 'small', clickEvent: () => this.save(), text:this.$t('sys.button.save'),
        name: "", //按钮图标样式
          position: "left",
          fuzzySearch: true},//保存
        {compKey: 'btnKey5', type: '', size: 'small', clickEvent: () => this.reset(), text:this.$t('sys.button.reset'),
        name: "", //按钮图标样式
          position: "right",
          fuzzySearch: true},//重置
        {compKey: 'btnKey3', type: '', size: 'small', clickEvent: () => this.exportExcel(), text:this.$t('sys.button.export'),
        name: "", //按钮图标样式
          position: "left",
          fuzzySearch: true},// '导出'
      ],
