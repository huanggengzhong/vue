  ...
  data() {
    return {
      ...
      tableButtons: [
        ...
        {compKey: 'btnKey4', type: '', size: 'small', clickEvent: () => this.examine(), text:  this.$t('sys.button.check')}/*审核*/,
      ...
      tableComponents: CacheConfig.cacheData[this.$route.path] && CacheConfig.cacheData[this.$route.path].tableComponents && CacheConfig.cacheData[this.$route.path].tableComponents.length > 0 ? CacheConfig.cacheData[this.$route.path].tableComponents : [
        ...
        {compKey: 'compKey3', labelName: this.$t('ve.label.discardTypeDate')/*报废日期*/, codeField: 'discardTypeDate', component: () => import('@/components/org/datePicker/datePicker'), type: 'datePicker', dateOptionsType: '0', isMust: true },
      ],
      // 动态生成网格列
      tableCols: CacheConfig.cacheData[this.$route.path] && CacheConfig.cacheData[this.$route.path].tableCols && CacheConfig.cacheData[this.$route.path].tableCols.length > 0 ? CacheConfig.cacheData[this.$route.path].tableCols : [
        ...
        { prop: 'discardType', label: this.$t('ve.label.discardType')/*报废类型*/, width: 110, align: 'center' },
        { prop: 'discardDescription', label: this.$t('ve.label.discardDescriptionCode')/*报废原因*/, width: 110, align: 'center' },
        { prop: 'discardDate', label: this.$t('ve.label.discardTypeDate')/*报废日期*/, width: 110, align: 'center' },
        { prop: 'carBrandCode', label: this.$t('org.label.carBrand')/*品牌*/, width: 110, align: 'center' },
