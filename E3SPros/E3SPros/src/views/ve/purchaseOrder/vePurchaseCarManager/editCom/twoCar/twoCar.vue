  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { prop: "purReqCode", label: "需求单号", width: null, align: "center" },
        { prop: "quantity", label: "数量", width: null, align: "center" },
        { prop: "secDlrName", label: "提交网点", width: null, align: "center" },
        {
          prop: "creator",
          label: "提交人",
          width: null,
