  ...
  methods: {
    getCols() {
      ...
      if (CacheConfig.cacheData[this.$route.path] && CacheConfig.cacheData[this.$route.path].tableCols.length > 0) {
        ...
        { prop: 'carDamageReturned', label: this.$t('ve.label.carDamageReturned'), width: 120, align: 'center' },//车损退回
    ...
    getRetuApplicaCols() {
      ...
      if (CacheConfig.cacheData[this.$route.path] && CacheConfig.cacheData[this.$route.path].tableCols.length > 0) {
        ...
        cols = cols.concat([
          {
            prop: "shippingMethodNo",
            label: this.$t('ve.label.shippingMethod')+'+',/*运输方式+*/
            width: 180,
            align: "center",
            isComponent: true,
            comps: [
          ...
          {
            prop: "warehouseNo",
            label: this.$t('ve.label.storageWarehouse')+'+',/*存放仓库+*/
            width: 180,
            align: "center",
            isComponent: true,
            comps: [
