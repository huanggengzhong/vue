<template>
  <div class="app-container app-container-table filter-params-crm-scroll">
    <div class="filter-container filter-button">
      ...
      <el-button size="small" @click="applyXZ">申请协助</el-button>
      <el-button size="small" @click="applyHF">申请回访</el-button>
      <el-button size="small" @click="reviewJA">直接结案</el-button>
    ...
    <div class="filter-container filter-params-crm filter-params-sub">
      <el-form label-position="right">
        <el-row>
          <el-col :span="6">
            <el-form-item label="达成结果">
              <el-select v-model="dcjg" placeholder="请选择">
                <el-option
        ...
        <el-row>
          <el-col :span="6" class="crm-label-required">
            <CheckThought ref="CheckThought" :CheckThought="1"/>
          </el-col>
        </el-row>
      </el-form>
    </div>
...
export default {
  ...
  methods: {
    ...
    save(val){
      ...
      //校验
      var html=""
      if(that.$refs.CheckThought.input==""||that.$refs.CheckThought.input==null)
      {
      ...
      that.$set(saveObj, "dealContent",that.$refs.CheckThought.input);
