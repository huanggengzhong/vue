  ...
  <el-form class="filter-params-crm-scroll" disabled>
    ...
    <div class="filter-container filter-params-crm">
      <el-row>
        ...
        <crmTextInput compKey="compKey3" labelName="可领取数量" :code="custFullName" codeField="custFullName" :span="8"></crmTextInput>
      </el-row>

      <el-row>
        <crmTextInput compKey="compKey4" labelName="单账号可领取数量" :code="credNo" codeField="credNo" :isRequire="true"></crmTextInput>
        <crmTextInput compKey="compKey5" labelName="可领取日期" :code="principalName" codeField="principalName"></crmTextInput>
        <crmTextInput compKey="compKey6" labelName="可核销期限" :code="addrCity" codeField="addrCity"></crmTextInput>
      </el-row>

      <el-row>
        <crmTextInput compKey="compKey8" labelName="发券部门" codeField="addrProvince" :code="addrProvince" :isRequire="false"></crmTextInput>
        <lookupvalue compKey="compKey41" :isMul="false" labelName="卡券使用类型" :code="gender" codeField="gender"></lookupvalue>
        <crmTextInput compKey="compKey10" labelName="使用渠道" codeField="addrCounty" :code="addrCounty" :isRequire="false"></crmTextInput>
      </el-row>

      <el-row>
        <lookupvalue compKey="compKey41" :isMul="false" labelName="使用条件" :code="gender" codeField="gender"></lookupvalue>
        <lookupvalue compKey="compKey41" :isMul="false" labelName="发放形式" :code="gender" codeField="gender"></lookupvalue>
        <lookupvalue compKey="compKey43" :isMul="false" labelName="是否启用" :code="gender" codeField="gender"></lookupvalue>
      </el-row>
      <el-row>
        <lookupvalue compKey="compKey43" :isMul="false" labelName="卡券类型" :code="gender" codeField="gender"></lookupvalue>
        <crmTextInput compKey="compKey44" :span="12" labelName="备注" :code="addr" codeField="addr" :isRequire="false"></crmTextInput>
    ...
    <div class="filter-container filter-params-crm">
      <el-row>
        <crmTextInput compKey="compKey13" labelName="卡券名称" :code="phone" codeField="phone" :isRequire="true"></crmTextInput>
        <crmTextInput compKey="compKey14" labelName="卡券编号" :code="backTel" codeField="backTel"></crmTextInput>
        <crmTextInput compKey="compKey15" labelName="可领取数量" :code="homeTel" codeField="homeTel"></crmTextInput>
      ...
      <el-row>
        ...
        <crmTextInput compKey="compKey19" labelName="开户行" :code="convTimeName" codeField="convTimeName"></crmTextInput>
      </el-row>
      <el-row>
    ...
    <div class="filter-container filter-params-crm">
      <el-row>
        <lookupvalue compKey="compKey24" :isMul="false" labelName="接触方式" :code="cantactWayCode" codeField="cantactWayCode"></lookupvalue>
        <lookupvalue compKey="compKey25" :isMul="false" labelName="渠道大类" :code="infoChanMCode" codeField="infoChanMCode"></lookupvalue>
        <el-col :span="6">
    ...
    <div class="filter-container filter-params-crm">
      <el-row>
        ...
        <el-col :span="22">
          <el-row>
            <crmTextInput compKey="compKey35" labelName="购车台次" :disabled="true" :code="buyCarNum" codeField="buyCarNum"></crmTextInput>
            <crmTextInput compKey="compKey36" labelName="权益订单" :disabled="true" :code="saleOrderNum" codeField="saleOrderNum"></crmTextInput>
            <crmTextInput compKey="compKey37" labelName="订单金额" :code="saleOrderMoney" codeField="saleOrderMoney"></crmTextInput>
            <crmTextInput compKey="compKey38" labelName="精品销售" :disabled="true" :code="accSaleMoney" codeField="accSaleMoney"></crmTextInput>
          </el-row>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="22">
          <el-row>
            <crmTextInput compKey="compKey39" labelName="累计回厂台次" :disabled="true" :code="totalBackNum" codeField="totalBackNum"></crmTextInput>
            <crmTextInput compKey="compKey40" labelName="近半年回厂台次" :disabled="true" :code="halfYearBackNum" codeField="halfYearBackNum"></crmTextInput>
            <crmTextInput compKey="compKey7" labelName="回厂消费金额" :disabled="true" :code="backMoney" codeField="backMoney"></crmTextInput>
            <crmTextInput compKey="compKey5" labelName="备件销售" :disabled="true" :code="partSaleMoney" codeField="partSaleMoney"></crmTextInput>
          </el-row>
        </el-col>
      </el-row>
    </div>
