    ...
    <el-col :span="span">
      ...
      >
        <el-option
          ...
          :key="item.smallAreaId"
          :label="item.smallAreaName"
          :value="item.smallAreaId"
        >{{item.smallAreaName}}</el-option>
      </el-select>
      <validateFormate
        :curLabelName="curLabelName"
        :validrule="validrule"
...
export default {
  ...
  props: {
    bigAreaId: { type: String, default: "" }
  },
  data() {
    return {
      placeholder: this.$t("sys.tips.esTip0"),
      curLabelName:
        this.labelName === "" ? this.$t('ve.label.smallArea') : this.labelName,
      // API配置对象
