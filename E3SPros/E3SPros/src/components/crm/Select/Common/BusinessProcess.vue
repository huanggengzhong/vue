<template>
    <el-form-item label="业务流程" :prop="checkprop">
...
export default {
    ...
    data() {
        return {
            value: this.BusinessProcess.value,
            checkprop:this.BusinessProcess.checkprop,
    ...
    methods: {
        getData: function() {
            ...
            this.value = this.BusinessProcess.value;
        },
        reset: function() {
            let that = this;
            this.value = "";
		...
		getNewData() {
            let that = this;
            that.value = this.BusinessProcess.value;
		},
