...
export default {
  ...
  data() {
	return {
	  value: this.NumberBrandStatus.value,
	...
	getData: function() {
	  ...
	  let queryObj = {
		...
		variables: {
		  ...
		  dataInfo: {lookupTypeCode:"DB0061"}//值列表编码
		}
	  };
	  ...
	  that.value=that.NumberBrandStatus.value
	},
	reset:function(){
	  let that=this
	  this.value=""
