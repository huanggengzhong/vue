...
export default {
  ...
  data() {
	return {
	  value: this.ConvenientContactTime.value,
	  isdisabled:this.ConvenientContactTime.isdisabled,
	...
	getData: function() {
	  ...
	  let queryObj = {
		...
		variables: {
		  ...
		  dataInfo: {lookupTypeCode:"DB0030"}//值列表编码
		}
	  };
	  ...
	  that.value=that.ConvenientContactTime.value
	},
	reset:function(){
	  let that=this
	  this.value=""
