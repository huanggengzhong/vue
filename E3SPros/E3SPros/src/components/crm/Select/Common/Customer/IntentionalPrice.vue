...
export default {
  ...
  data() {
	return {
	  value: this.IntentionalPrice.value,
		isdisabled:this.IntentionalPrice.isdisabled,
		labelname:(this.IntentionalPrice.labelname==undefined?"意向价格":this.IntentionalPrice.labelname),
	...
	getData: function() {
	  ...
	  let queryObj = {
		...
		variables: {
		  ...
		  dataInfo: {lookupTypeCode:'APPVE9527_09'}//值列表编码
		}
	  };
	  ...
	  that.value=that.IntentionalPrice.value
	},
	reset:function(){
	  let that=this
	  this.value=''
