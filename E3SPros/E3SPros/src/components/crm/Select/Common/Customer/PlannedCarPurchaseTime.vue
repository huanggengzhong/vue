...
export default {
  ...
  data() {
	return {
	  value: this.PlannedCarPurchaseTime.value,
	  options:this.getData(),
	  isdisabled:this.PlannedCarPurchaseTime.isdisabled
	};
  },
  mounted: function() {
  },
	...
	getData: function() {
	  ...
	  let queryObj = {
		...
		variables: {
		  ...
		  dataInfo: {lookupTypeCode:'MDM_BUY_PLAN'}//值列表编码
		}
			};
	  ...
	  that.value=this.PlannedCarPurchaseTime.value
	},
	reset:function(){
	  let that=this
	  this.value=''
