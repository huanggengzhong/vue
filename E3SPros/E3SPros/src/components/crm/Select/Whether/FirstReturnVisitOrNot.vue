...
export default {
  ...
  data() {
    return {
      ...
      value: this.FirstReturnVisitOrNot.value,
      isdisabled:this.FirstReturnVisitOrNot.isdisabled,
    };
  },
  mounted: function() {
    // this.getData();
  ...
  methods: {
    getData: function() {
      ...
      that.value = that.FirstReturnVisitOrNot.value;
    },
				levelChange(){
					let that = this
