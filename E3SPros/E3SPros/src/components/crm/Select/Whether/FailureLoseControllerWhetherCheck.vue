<template>
  <el-form-item label="战败失控是否审核" prop="failContrloIsCheck.value">
...
export default {
  name: "FailureLoseControllerWhetherCheck",
  props: {
  ...
  data() {
    return {
      value: this.FailureLoseControllerWhetherCheck.value,
  ...
  methods: {
    getData: function() {
      ...
      that.value=this.FailureLoseControllerWhetherCheck.value
    },
    reset: function() {
      let that = this;
      this.value = "";
