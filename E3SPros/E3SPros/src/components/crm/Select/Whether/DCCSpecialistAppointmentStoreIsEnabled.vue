<template>
  <el-form-item label="电销员预约到店是否启用" prop="isDcc.value">
...
export default {
  name: "DCCSpecialistAppointmentStoreIsEnabled",
  props:{
  ...
  data() {
    return {
      value: this.DCCSpecialistAppointmentStoreIsEnabled.value,
    ...
    getData: function() {
      ...
      let queryObj = {
        ...
        variables: {
          ...
          dataInfo: {lookupTypeCode:'LX007'}//值列表编码
        }
      };
      ...
      that.value=this.DCCSpecialistAppointmentStoreIsEnabled.value
    },
    reset:function(){
      let that=this
      this.value=''
