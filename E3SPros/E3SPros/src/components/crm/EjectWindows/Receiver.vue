<template>
  <section>
    ...
    <!-- 短信模板弹窗 -->
    <el-dialog title="员工" :visible.sync="dialogVisible" @sentData="sendCode" :append-to-body="true" width="900px" center>
...
export default {
  ...
  methods: {
    showdialog: function() {
      let that = this;
      console.log("进来了");
      if (this.Receiver.dialogVisible == false) {
        that.dialogVisible = this.Receiver.dialogVisible;
      } else {
