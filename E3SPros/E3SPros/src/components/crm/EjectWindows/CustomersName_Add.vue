<template>
  <section>
    ...
    <el-form-item label="客户名称" prop="custName.input">
      ...
      <el-button
        class="icon-button"
        style="position: absolute;top: 0;right: 19px;top: 3px;"
        @click.native="showdialog()"
        icon="el-icon-more-outline"
      ></el-button>
      <el-button
        class="icon-button"
        style="position: absolute;top: 0;right:0;top: 3px;"
        @click.native="addDialog()"
        icon="el-icon-plus"
      ></el-button>
    </el-form-item>

    <!-- <el-col class="icon-col" :span="4"> -->
    ...
    >
      <div class="filter-container filter-title-crm">
        <div style="float:right">
          ...
          <el-button type="primary" size="small" @click="fetchData_add(form)">保存</el-button>
          <!-- <el-button size="small" @click="handleSelect_add">确认</el-button> -->
        </div>
      </div>
      <div class="filter-container filter-params-crm">
        <el-form :model="form" ref="form">
          <el-row>
            <el-col :span="6" class="crm-label-required">
              <CustomerName ref="txtcust" :txt_CustomerName="txtcust"></CustomerName>
            </el-col>

            <el-col :span="6">
              <Sex ref="Sex" :Sex="Sex"></Sex>
            </el-col>

            <el-col :span="6">
              <Birthday :Birthday="Birth" ref="Birthday"></Birthday>
            </el-col>

            <el-col :span="6">
              <ITCard :ITCard="ITcar" ref="ITCard"></ITCard>
            </el-col>
          </el-row>

          <el-row>
            <el-col :span="6" class="crm-label-required">
              <PhoneNumber :PhoneNumber="Phone1" ref="Phone1"></PhoneNumber>
            </el-col>

            <el-col :span="6">
              <HomePhone :HomePhone="Homephone" ref="HomePhone"></HomePhone>
            </el-col>
          ...
          <el-row>
            <el-col :span="6">
              <Province ref="Province" :Province="addpro" @changeCode="changepro"></Province>
            </el-col>

            <el-col :span="6">
              <City ref="City" :City="addcity" @changeCode="changecity"></City>
            </el-col>

            <el-col :span="6">
              <District ref="District" :District="adddistrict" @changeCode="changedistr"></District>
            </el-col>

            <el-col :span="6">
              <EMS :EMS="addems" ref="EMS"></EMS>
            </el-col>
          </el-row>

          <el-row>
            <el-col :span="6">
              <txt_DetailAddress :txt_DetailAddress="Address" ref="DetailAddress"></txt_DetailAddress>
            </el-col>
          </el-row>
        </el-form>
      </div>
      <el-table
        :data="adddatas.tableData"
        @current-change="addSelect"
      ...
      >
        ...
        <el-table-column
          v-for="item in adddatas.colnames"
          :key="item.value"
          :label="item.label"
          :prop="item.value"
          align="center"
      ...
      <el-pagination
        ...
        :total="adddatas.total"
        :page-size="adddatas.pagesize"
        :current-page="adddatas.pageindex"
        @prev-click="prev"
        @next-click="next"
...
export default {
  ...
  methods: {
    ...
    showdialog: function() {
      ...
      if (this.CustomersName_Add.dialogVisible == false) {
        that.dialogVisible = this.CustomersName_Add.dialogVisible;
      } else {
    ...
    addSelect: function(row) {
      ...
      that.rowData.genderCode = row.genderCode;
      that.rowData.phone = row.phone;
      that.rowData.backTel = row.backTel;
      that.rowData.carLicenseNo = row.carLicenseNo;
      that.rowData.vin = row.vin;

      that.rowData.engineNo = row.engineNo;
      that.rowData.carBrandName = row.carBrandName;
      that.rowData.smallCarTypeCn = row.smallCarTypeCn;
    ...
    getData() {
      let that = this;
      that.input = this.CustomersName_Add.input;
    },
    resetinput() {
      let that = this;
      that.input = "";
