...
import NodeGroupPop from "@/components/crm/crmEjectWindows/crmNodeGroupPop/crmNodeGroupPop";
...
export default {
  ...
  data() {
    return {
      curLabelName: this.labelName === "" ? "节点组" : this.labelName,
      curValueObject: {
        oemCode: "1",
        groupCode: "1"
      }
