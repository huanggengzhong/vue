...
import LostReason from "@/components/crm/crmEjectWindows/crmLostReason/crmLostReason";
...
export default {
  ...
  data() {
    return {
      curLabelName: this.labelName === "" ? "失控原因" : this.labelName,
      curValueObject: {
        isEnable: "1",
        failReasonType: "2",
      }
