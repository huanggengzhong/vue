...
export function doQueryList(pageSize, pageIndex, dataInfo) { // 查询工时备件关联列表
  const queryObj = {
    ...
    type: 'query',
    typeParam:
      '($pageIndex: Int, $pageSize: Int, $dataInfo: ' + paApis.paBuOemDlrAccountQueryFindAll.InputType + ')',
    // 请求API
    apiUrl: paApis.paBuOemDlrAccountQueryFindAll.APIUrl,
    // 需要调用的API服务配置
    apiServices: [
      {
        // API服务编码&参数
        apiServiceCode: paApis.paBuOemDlrAccountQueryFindAll.ServiceCode,
        apiServiceParam:
