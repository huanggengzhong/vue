...
export function doQueryList(pageSize, pageIndex, dataInfo) {
  ...
  const queryObj = {
    ...
    typeParam:
      ...
      paApis.paDbTransitRelationQueryFindAll.InputType +
      ')',
    // 请求API
    apiUrl: paApis.paDbTransitRelationQueryFindAll.APIUrl,
    // 需要调用的API服务配置
    apiServices: [
      {
        // API服务编码&参数
        apiServiceCode: paApis.paDbTransitRelationQueryFindAll.ServiceCode,
        apiServiceParam:
...
export function doLinkSave(dataInfo) {
  ...
  const queryObj = {
    ...
    type: 'mutation',
    typeParam:
      '($dataInfo: ' + paApis.paDbTransitRelationMutationSave.InputType + ')',
    // 请求API
    apiUrl: paApis.paDbTransitRelationMutationSave.APIUrl,
    // 需要调用的API服务配置
    apiServices: [
      {
        // API服务编码&参数
        apiServiceCode: paApis.paDbTransitRelationMutationSave.ServiceCode,
        apiServiceParam: '(dataInfo: $dataInfo)',
        // 表格中台返回网格的字段
        apiQueryRow: []
      }
